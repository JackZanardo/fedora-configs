...
function M.setup()
  ...
  -- mini.pick
  hi('MiniPickNormal',         { fg = '#f2f2f3',          bg = '#0c2132' })
  hi('MiniPickBorder',         { fg = '#616b71',             bg = '#0c2132' })
  hi('MiniPickPrompt',   { fg = '#f2f2f3',          bg = '#0c2132' })
  hi('MiniPickPromptPrefix',   { fg = '#67afe4',             bg = '#0c2132' })
  hi('MiniPickBorderText',    { fg = '#0c2132',             bg = '#67afe4' })
  hi('MiniPickMatchCurrent',      { fg = '#f2f2f3',          bg = '#11324b' })
  hi('MiniPickPromptCaret', { fg = '#67afe4',             bg = '#11324b' })
